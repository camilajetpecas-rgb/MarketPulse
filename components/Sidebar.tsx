...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen }) => {
  ...
  const navItems = [
    ...
    { name: 'Analisador de Anúncios', path: '/analyzer', icon: <Search size={20} /> },
    { name: 'Criador de Títulos', path: '/title-builder', icon: <PenTool size={20} /> },
    { name: 'Tendências de Mercado', path: '/trends', icon: <TrendingUp size={20} /> },
    { name: 'Catálogo ML', path: '/catalog', icon: <BookOpen size={20} /> },
    { name: 'Mapa de Demanda', path: '/geo-trends', icon: <Map size={20} /> },
  ];
